...
final clubTournamentsProvider =
    FutureProvider.family<List<Tournament>, String>((ref, clubId) async {
...
final tournamentDetailProvider = FutureProvider.family<TournamentDetail,
    ({String clubId, String tournamentId})>((ref, params) async {
  final api = ref.read(apiClientProvider);
...
final tournamentRoundsProvider = FutureProvider.family<List<TournamentRound>,
    ({String clubId, String tournamentId})>((ref, params) async {
  final api = ref.read(apiClientProvider);
  final response = await api.dio.get(
...
final tournamentLeaderboardProvider =
    FutureProvider.family<List<TournamentLeaderboardEntry>,
        ({String clubId, String tournamentId})>((ref, params) async {
  final api = ref.read(apiClientProvider);
  final response = await api.dio.get(
...
final roundLeaderboardProvider =
    FutureProvider.family<List<TournamentRoundScore>,
