  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-lg mx-auto px-4 py-6">
        ...
        {/* Share on social */}
        <ShareButtons
          text={`${session.archer_name} scored ${session.total_score} on ${session.template_name}!`}
        />
  ...
  return (
    <div className="mt-4 flex items-center justify-center gap-3">
      ...
      <a
        ...
        className="w-8 h-8 rounded-full bg-[#1877F2] text-white flex items-center justify-center hover:opacity-80"
      ...
      <button
        onClick={handleCopy}
        className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 text-white flex items-center justify-center hover:opacity-80"
